    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState == 4 && xhr.status == 200) {
            if (xhr.responseText == "0") {
                ...
                article.setAttribute("class", "persona bg-light");

                var h5 = document.createElement("h5");
                h5.setAttribute("style", "font-weight: 600;");
                h5.setAttribute("class", "center");
                h5.appendChild(document.createTextNode("Nada que mostrar"));
                article.appendChild(h5);

                var img = document.createElement("img");
                img.setAttribute("src", "img/noData.gif");
                img.setAttribute("class", "gif");
                article.appendChild(img);

                var a = document.createElement("a");
                a.setAttribute("class", "badge badge-info center button_des");
                a.setAttribute("href", "EncontrarAAlguien.jsp");
                a.appendChild(document.createTextNode("Busca a alguien"));
